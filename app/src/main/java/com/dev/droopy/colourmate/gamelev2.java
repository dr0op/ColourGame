...
public class gamelev2 extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gamelev2);
    ...
    public void updatePoints() {
        ...
        timer+=2;
        if(points>=1000){
            Intent i=new Intent(this,gamelev3.class);
            finish();
            startActivity(i);
