...
public class gamelev4 extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gamelev4);
    ...
    private int[] shuffledColors() {
        ...
        int[] arr = {255, 185, 155,175,210,190, 225,200,170};
